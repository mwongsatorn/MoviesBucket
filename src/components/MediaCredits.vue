...
import type {
  ShortPersonWithCast,
  ShortPersonWithCrew,
  ShortPersonWithAggregateCast,
  ShortPersonWithAggregateCrew,
} from "@/types";

interface Inject {
  cast: ShortPersonWithCast[] | ShortPersonWithAggregateCast[];
  crew: ShortPersonWithCrew[] | ShortPersonWithAggregateCrew[];
}
